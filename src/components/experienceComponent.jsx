...
const timeline = [
  ...
  {
    name: "Minsait - Consultant Developer",
    description:
...
const ExperienceComponent = () => {
  return (
    <div className="animate__animated animate__fadeIn mx-auto -mt-8 max-w-7xl px-6 lg:px-8 ">
        ...
        {timeline.map((item) => (
          <div key={item.name}>
            ...
            >
              <svg
                viewBox="0 0 4 4"
                className="mr-2 h-2 w-2 flex-none"
                aria-hidden="true"
              >
            ...
            <p className="mt-6 text-xl font-semibold leading-8 tracking-tight text-black hover:text-sky-500">
              {item.name}
            </p>
            <p className="mt-1 text-lg leading-7 text-black">
              {item.description}
            </p>
          </div>
        ))}
