...
const ContactPage= () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_z52leef', 'template_hcnyh7q', form.current, 'GF99YxRQaQchpt5op')
      .then((result) => {
          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 max-w-3xl text-xl text-warm-gray-500">
                ¡Hola! Si necesitas contactarme por algún motivo, por favor no dudes en hacerlo.
                Puedes enviarme un correo electrónico a la dirección que se encuentra en esta página o completar el formulario de contacto también disponible aquí. 
                <strong className='text-indigo-500'> ¡Espero tener noticias tuyas pronto!</strong> 
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="relative bg-transparent shadow-xl">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="rounded-lg relative overflow-hidden bg-gradient-to-b from-indigo-300 to-indigo-400 py-10 px-6 sm:px-10 xl:p-12">
                  ...
                  Además de mi correo electrónico y formulario de contacto, también puedes encontrarme en Twitter, 
                  Instagram y Facebook. Sígueme para estar al tanto de mis últimas publicaciones y novedades, y no dudes en enviarme un mensaje directo si necesitas ayuda o tienes alguna pregunta.
                  </p>
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50">
                      ...
                      <span className="ml-3">juan1992b.ortiz@gmail.com</span>
                    </dd>
                  </dl>
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  ...
                  <form ref={form} onSubmit={sendEmail} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    <div>
                      <label for="email_id" className="block text-sm font-medium text-warm-gray-900">
                        Email
                      </label>
                      <div className="mt-1">
                        <input
