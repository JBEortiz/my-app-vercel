        ...
        <Navbar></Navbar>
         <div className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 sm:px-6">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl hover:scale-110 hover:text-sky-500 duration-300">
                  Pruebas de  concepto
              ...
              <p className="mx-auto mt-3 max-w-md text-base text-gray-900 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                Mi pequeña  <strong className='text-indigo-500'>enciclopedia</strong> donde se encuentran mis  <strong className='text-indigo-500'>proyectos y pruebas de concepto</strong>, que muchas veces me resultan muy utiles para recordar como hacer algo.
              </p>
            </div>
          </div>
          <br></br>
