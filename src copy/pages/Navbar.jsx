          ...
          <div className="relative flex  h-16 justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                ...
                <a
                  href="/home"
                  className="inline-flex items-center border-b-2 focus:border-sky-500 px-1 pt-1 text-sm font-medium text-gray-900 hover:border-gray-300 hover:text-indigo-500"
                >
                  Home
                </a>
                <a
                  href="/projects"
                  className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-900 hover:border-gray-300 hover:text-indigo-500"
                >
                  Proyectos
                </a>
